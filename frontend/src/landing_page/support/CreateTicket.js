...
function CreateTicket() {
    return ( 
        <div className='container'>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className=''><i class="fa-regular fa-user"></i>
                ...
                <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Transfer and conversion of securities
                </a>
            </div>
            <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className=''><i class="fa-solid fa-grip-lines-vertical"></i>
                    Kite
                </h4>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className=''><i class="fa-regular fa-folder"></i>
                    Funds
                </h4>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className=''><i class="fa-regular fa-circle-dot"></i>
                    Console
                </h4>
